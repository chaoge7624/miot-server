...
import org.springblade.mapper.WarningMapper;
...
public class WarningServiceImpl extends BaseServiceImpl<WarningMapper, Warning> implements IWarningService {
	...
	@Override
	public IPage<WarningVO> selectWarningPage(IPage<WarningVO> page, WarningVO warning) {
		return page.setRecords(baseMapper.selectWarningPage(page, warning));
	}
