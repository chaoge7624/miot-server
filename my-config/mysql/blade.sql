/*
 ...
 Source Server         : 192.168.247.184
 Source Server Type    : MySQL
 Source Server Version : 80029
 Source Host           : 192.168.247.184:3326
 Source Schema         : blade
...
INSERT INTO `blade_code` VALUES (1551067541160427522, 1123598812738675201, 'blade-office', '办公管理-告警表', 'blade_warning', 'blade_', 'id', 'org.springblade', 2, 2, 'E:\\44_JAVA_Protect\\0-通用物联网平台架构-bladeX\\miot-server\\blade-service\\blade-basics\\blade-office', 'E:\\44_JAVA_Protect\\0-通用物联网平台架构-bladeX\\miot-web', 0);
...
-- ----------------------------
INSERT INTO `blade_datasource` VALUES (1123598812738675201, 'mysql', 'com.mysql.cj.jdbc.Driver', 'jdbc:mysql://192.168.247.184:3326/blade?useSSL=false&useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&transformedBitIsBoolean=true&tinyInt1isBit=false&allowMultiQueries=true&serverTimezone=GMT%2B8', 'root', '123456', 'mysql', 1, '2019-08-14 11:43:06', 1123598821738675201, '2022-07-24 12:51:22', 1, 0, -1);
INSERT INTO `blade_datasource` VALUES (1123598812738675202, 'postgresql', 'org.postgresql.Driver', 'jdbc:postgresql://127.0.0.1:5432/blade', 'postgres', '123456', 'postgresql', 1, '2019-08-14 11:43:41', 1, '2019-08-14 11:43:41', 1, 0, NULL);
INSERT INTO `blade_datasource` VALUES (1123598812738675203, 'oracle', 'oracle.jdbc.OracleDriver', 'jdbc:oracle:thin:@127.0.0.1:49161:orcl', 'BLADE', 'blade', 'oracle', 1, '2019-08-14 11:44:03', 1, '2019-08-14 11:44:03', 1, 0, NULL);
...
-- ----------------------------
INSERT INTO `blade_dept` VALUES (1123598813738675201, '000000', 0, '0', '超级牛逼', '超级牛逼有限公司', 1, '', 0);
INSERT INTO `blade_dept` VALUES (1123598813738675202, '000000', 1123598813738675201, '0,1123598813738675201', '人事部', '超级牛逼有限公司', 1, '', 0);
INSERT INTO `blade_dept` VALUES (1123598813738675203, '000000', 1123598813738675201, '0,1123598813738675201', '开发部', '超级牛逼有限公司', 1, '', 0);
...
INSERT INTO `blade_dict` VALUES (1551060961585037314, 0, 'subsystem_type', -1, '子系统类型', 14, '子系统类型', 0);
INSERT INTO `blade_dict` VALUES (1551061118724636673, 1551060961585037314, 'subsystem_type', 1, '照明', 1, '照明', 0);
INSERT INTO `blade_dict` VALUES (1551061288329707522, 1551060961585037314, 'subsystem_type', 2, '窗帘', 2, '窗帘', 0);
INSERT INTO `blade_dict` VALUES (1551061342608195585, 1551060961585037314, 'subsystem_type', 3, '新风', 3, '新风', 0);
INSERT INTO `blade_dict` VALUES (1551061574406406145, 1551060961585037314, 'subsystem_type', 4, '空调', 4, '空调', 0);
INSERT INTO `blade_dict` VALUES (1551061689888178178, 1551060961585037314, 'subsystem_type', 5, '音乐广播', 5, '音乐广播', 0);
INSERT INTO `blade_dict` VALUES (1551061817608929282, 1551060961585037314, 'subsystem_type', 6, '视频监控', 6, '视频监控', 0);
INSERT INTO `blade_dict` VALUES (1551061861724618754, 1551060961585037314, 'subsystem_type', 7, '门禁', 7, '门禁', 0);
INSERT INTO `blade_dict` VALUES (1551062076980494337, 1551060961585037314, 'subsystem_type', 8, '停车管理', 8, '停车管理', 0);
INSERT INTO `blade_dict` VALUES (1551062314331963393, 1551060961585037314, 'subsystem_type', 9, '电子巡更', 9, '电子巡更', 0);
...
CREATE TABLE `blade_dict_biz`  (
  ...
  `sort` int(0) NULL DEFAULT NULL COMMENT '排序',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '字典备注',
  `is_sealed` int(0) NULL DEFAULT 0 COMMENT '是否已封存',
  `is_deleted` int(0) NULL DEFAULT 0 COMMENT '是否已删除',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `blade_menu` VALUES (1123598815738675211, 1123598815738675210, 'doc', '接口文档', 'menu', 'http://localhost:18000/doc.html', 'iconfont iconicon_study', 1, 1, 0, 2, NULL, 0);
...
INSERT INTO `blade_menu` VALUES (1551068160185171970, 1551071119174377473, 'warning', '告警列表', 'menu', '/office/warning', 'iconfont iconicon_secret', 1, 1, 3, 1, '', 0);
INSERT INTO `blade_menu` VALUES (1551068160185171971, 1551068160185171970, 'warning_add', '新增', 'add', '/office/warning/add', 'plus', 1, 2, 1, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1551068160185171972, 1551068160185171970, 'warning_edit', '修改', 'edit', '/office/warning/edit', 'form', 2, 2, 2, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1551068160185171973, 1551068160185171970, 'warning_delete', '删除', 'delete', '/api/blade-office/warning/remove', 'delete', 3, 2, 3, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1551068160185171974, 1551068160185171970, 'warning_view', '查看', 'view', '/office/warning/view', 'file-text', 4, 2, 2, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1551071119174377473, 0, 'office', '办公管理', 'menu', '/office', 'iconfont icon-rizhi', 96, 1, 3, 1, '办公管理', 0);
...
INSERT INTO `blade_role_menu` VALUES (1551072261375631362, 1123598815738675201, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261375631363, 1123598815738675202, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261375631364, 1123598815738675219, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261375631365, 1123598815738675220, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261375631366, 1123598815738675221, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261438545922, 1123598815738675222, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261438545923, 1123598815738675203, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261438545924, 1123598815738675204, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261438545925, 1123598815738675223, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261438545926, 1123598815738675224, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261438545927, 1123598815738675225, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261438545928, 1123598815738675226, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261438545929, 1123598815738675227, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261438545930, 1123598815738675228, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261438545931, 1123598815738675205, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261501460482, 1123598815738675229, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261501460483, 1123598815738675230, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261501460484, 1123598815738675231, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261501460485, 1123598815738675232, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261501460486, 1123598815738675206, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261501460487, 1123598815738675233, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261501460488, 1123598815738675234, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261501460489, 1123598815738675235, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261501460490, 1123598815738675236, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261501460491, 1123598815738675207, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261501460492, 1123598815738675237, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261564375041, 1123598815738675238, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261564375042, 1123598815738675239, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261564375043, 1123598815738675240, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261564375044, 1123598815738675209, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261564375045, 1123598815738675245, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261564375046, 1123598815738675246, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261564375047, 1123598815738675247, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261564375048, 1123598815738675248, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261564375049, 1123598815738675256, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261564375050, 1123598815738675257, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261627289602, 1123598815738675258, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261627289603, 1123598815738675259, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261627289604, 1123598815738675260, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261627289605, 1123598815738675261, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261627289606, 1123598815738675262, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261627289607, 1123598815738675263, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261627289608, 1123598815738675264, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261627289609, 1123598815738675265, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261627289610, 1164733389668962251, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261627289611, 1164733389668962252, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261627289612, 1164733389668962253, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261627289613, 1164733389668962254, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261694398466, 1164733389668962255, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261694398467, 1123598815738675210, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261694398468, 1123598815738675211, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261694398469, 1123598815738675212, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261694398470, 1123598815738675213, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261694398471, 1123598815738675214, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261694398472, 1123598815738675249, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261694398473, 1123598815738675215, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261694398474, 1123598815738675250, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261694398475, 1123598815738675216, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261757313025, 1123598815738675251, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261757313026, 1123598815738675217, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261757313027, 1123598815738675218, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261757313028, 1123598815738675252, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261757313029, 1123598815738675253, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261757313030, 1123598815738675254, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261757313031, 1123598815738675255, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261757313032, 1123598815738675266, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261757313033, 1123598815738675267, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261757313034, 1123598815738675268, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261757313035, 1123598815738675269, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261824421889, 1123598815738675270, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261824421890, 1123598815738675307, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261824421891, 1123598815738675308, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261824421892, 1123598815738675241, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261824421893, 1123598815738675242, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261824421894, 1123598815738675243, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261824421895, 1123598815738675244, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261824421896, 1123598815738675309, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261824421897, 1123598815738675310, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261824421898, 1164733399668962201, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261887336449, 1164733399668962202, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261887336450, 1164733399668962203, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261887336451, 1164733399668962204, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261887336452, 1164733399668962205, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261887336453, 1164733399668962206, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261887336454, 1164733399668962207, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261887336455, 1164733399669962301, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261887336456, 1164733399669962302, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261887336457, 1164733399669962303, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261887336458, 1551071119174377473, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261887336459, 1551068160185171970, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261950251010, 1551068160185171971, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261950251011, 1551068160185171972, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261950251012, 1551068160185171973, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1551072261950251013, 1551068160185171974, 1123598816738675201);
...
CREATE TABLE `blade_scope_api`  (
  ...
  `scope_type` int(0) NULL DEFAULT NULL COMMENT '接口权限类型',
...
CREATE TABLE `blade_tenant_package`  (
  ...
  `is_deleted` int(0) NULL DEFAULT 0 COMMENT '是否已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '租户产品表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `blade_top_menu`  (
  ...
  `sort` int(0) NULL DEFAULT NULL COMMENT '顶部菜单排序',
  `create_user` bigint(0) NULL DEFAULT NULL COMMENT '创建人',
  `create_dept` bigint(0) NULL DEFAULT NULL COMMENT '创建部门',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_user` bigint(0) NULL DEFAULT NULL COMMENT '修改人',
...
CREATE TABLE `blade_top_menu_setting`  (
  `id` bigint(0) NOT NULL COMMENT '主键',
  `top_menu_id` bigint(0) NULL DEFAULT NULL COMMENT '顶部菜单主键',
  `menu_id` bigint(0) NULL DEFAULT NULL COMMENT '菜单主键',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `blade_user_app`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户平台拓展表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for blade_warning
-- ----------------------------
DROP TABLE IF EXISTS `blade_warning`;
CREATE TABLE `blade_warning`  (
  `id` bigint(0) NOT NULL COMMENT '主键id',
  `level` int(0) NULL DEFAULT NULL COMMENT '告警级别',
  `type` int(0) NULL DEFAULT NULL COMMENT '告警类型',
  ...
  `is_work_order` int(0) NULL DEFAULT NULL COMMENT '是否派发了工单，0否，1是',
  `subsystem_type` int(0) NULL DEFAULT NULL COMMENT '关联子设备系统类型',
  `equipment_id` bigint(0) NULL DEFAULT NULL COMMENT '告警关联的设备id',
  `create_user` bigint(0) NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_user` bigint(0) NULL DEFAULT NULL COMMENT '修改人',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  `status` int(0) NULL DEFAULT NULL COMMENT '告警状态，0待处理，1处理中，2已处理',
  `is_deleted` int(0) NULL DEFAULT 0 COMMENT '是否已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of blade_warning
-- ----------------------------
INSERT INTO `blade_warning` VALUES (1551078742233735170, 1, 1, '1', '2022-07-24 13:36:37', 1, 1, 1, 1123598821738675201, '2022-07-24 13:36:04', 1123598821738675201, '2022-07-24 13:36:04', 1, 0);
